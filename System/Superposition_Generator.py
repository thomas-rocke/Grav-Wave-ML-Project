...
class SuperpositionGenerator(keras.utils.Sequence):#, ModeProcessor):
    ...
    '''
    def __init__(self, max_order:int=3, batch_size:int=64, repeats:int=64, training_strategy_name:str="default", network_resolution:int=64, camera_resolution:int=64, starting_stage:int=1, info:bool = False):
        '''
        Init the class
        '''
