...
class Hermite:
    ...
    def __init__(self, l: int = -1, m: int = -1, amplitude: float = 1.0, phase: float = 0.0, w_0: float = 0.4, wavelength: float = 600.0, n: int = 500, pixels=128):
        '''
        Initialise class.
        '''
        self.l = l
...
class Superposition(list):
    ...
    def __init__(self, *modes, pixels=128):
        '''
...
class Laguerre(Superposition):
    ...
    def __init__(self, p: int = 1, m: int = 1, amplitude: float = 1.0, phase: float = 0.0, pixels=128):
        '''
