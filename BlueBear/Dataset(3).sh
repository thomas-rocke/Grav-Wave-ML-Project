...
python3 Main.py -i "ML(Dataset('stage_change_test', 3))" -t -s -e 1000
python3 Main.py -i "ML(Dataset('slow_curve', 3))" -t -s -e 1000
python3 Main.py -i "ML(Dataset('fast_curve', 3))" -t -s -e 1000
python3 Main.py -i "ML(Dataset('errors_throughout', 3))" -t -s -e 1000
python3 Main.py -i "ML(Dataset('errors_at_end', 3))" -t -s -e 1000
