...
python3 Main.py -i "ML(BasicGenerator(5, 5))" -o "repeats" "[2**n for n in range(9)]"
...
python3 Main.py -i "ML(BasicGenerator(5, 5))" -o "noise_variation" "[round(0.1 * n, 1) for n in range(1, 11)]"
python3 Main.py -i "ML(BasicGenerator(5, 5))" -o "amplitude_variation" "[round(0.1 * n, 1) for n in range(1, 11)]"
python3 Main.py -i "ML(BasicGenerator(5, 5))" -o "phase_variation" "[round(0.2 * n, 1) for n in range(1, 11)]"