...
python3 Main.py -i "ML(Dataset('stage_change_test', 5))" -t -s -e 1000
python3 Main.py -i "ML(Dataset('slow_curve', 5))" -t -s -e 1000
python3 Main.py -i "ML(Dataset('fast_curve', 5))" -t -s -e 1000
python3 Main.py -i "ML(Dataset('errors_throughout', 5))" -t -s -e 1000
python3 Main.py -i "ML(Dataset('errors_at_end', 5))" -t -s -e 1000
