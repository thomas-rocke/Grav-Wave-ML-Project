...
python3 Main.py -i "ML(BasicGenerator(5, 5, 0.2, 0.4))" -t -s -e 1000
python3 Main.py -i "ML(BasicGenerator(5, 5, 0.5, 1.0))" -t -s -e 1000
python3 Main.py -i "ML(BasicGenerator(5, 5, 1.0, 2.0))" -t -s -e 1000