...
class Gaussian:
    ...
    def copy(self):
        ...
        '''
        return Gaussian(self.l, self.m, self.amplitude, self.w_0, self.wavelength, self.n)
...
class Generate_Data(list):
    ...
    def __init__(self, max_order: int = 1, number_of_modes: int = 1, amplitude_variation: float = 0.0, repeats: int = 1, info: bool = True):
        ...
        gauss_modes = [Gaussian(l=i, m=j) for i in range(max_order) for j in range(max_order)]
